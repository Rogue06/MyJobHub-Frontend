...
export const ACTIONS: ActionDefinition[] = [
  // ==== Slash commands — évaluation
  {
    ...
    description: "CV ATS-optimisé adapté à une offre. Garde les keywords du JD, structure ATS, design Space Grotesk + DM Sans.",
  ...
  },
  {
    ...
    kind: "slash",
    command: "latex",
    title: "Exporter en LaTeX / Overleaf",
    description: "Compile ton CV au format .tex puis PDF via tectonic ou pdflatex. Pour une mise en page typographique pro.",
